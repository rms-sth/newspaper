...
class ClientPostCategory(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["categories"] = Category.objects.all()
        post__category = Category.objects.get(
            id=self.kwargs["pk"]
        )  # taking single category name
...
class AdminGalleryView(View):
    def get(self, request):
        ...
        return render(
            self.request,
            "admintemplates/newsapp/albumcreate.html",
            {"photos": photos_list},
        )
...
def adminDeleteImage(request, pk):
    ...
    if request.method == "POST" and request.is_ajax():
        ...
        data["photo_list"] = render_to_string(
            "admintemplates/newsapp/albumcreate.html", {"photos": photos}
        )
    else:
        context = {"photo": photo}
        data["html_form"] = render_to_string(
            "admintemplates/newsapp/albumcreate.html", context, request=request
        )
