...
urlpatterns = [
    ...
    path(
        "posts/category/<int:pk>/",
        ClientPostCategory.as_view(),
        name="clientnewscategory",
    ),
    # CLIENT URL PATTERNS
    # path('', ClientHomeView.as_view(), name="clienthome"),
    ...
    path(
        "admin-login/",
        auth_views.LoginView.as_view(template_name="admintemplates/adminlogin.html"),
        name="adminlogin",
    ),
    path(
        "admin-logout/",
        auth_views.LogoutView.as_view(template_name="admintemplates/adminlogout.html"),
        name="adminlogout",
    ),
    # ADMIN:NEWS CRUD
    path("admin-panel/news/", AdminNewsListView.as_view(), name="adminnewslist"),
    path(
        "admin-panel/news/<int:pk>/detail/",
    ...
    path(
        "admin-panel/news/<int:pk>/update/",
        AdminNewsUpdateView.as_view(),
        name="adminnewsupdate",
    ),
    path(
        "admin-panel/news/<int:pk>/delete/",
